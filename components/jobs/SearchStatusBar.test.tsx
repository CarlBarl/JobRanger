...
const messages = {
  jobs: {
    searchStatus: {
      ...
      searchingFoundPending: 'Found {count} jobs so far ({pending} searches left)...',
...
describe('SearchStatusBar', () => {
  it('returns null when phase is idle', () => {
    const { container } = renderWithIntl(
      <SearchStatusBar phase="idle" totalFound={0} pendingQueries={0} failedQueries={0} />
    )
  ...
  it('shows "Searching for jobs..." when searching with 0 results', () => {
    renderWithIntl(
      <SearchStatusBar phase="searching" totalFound={0} pendingQueries={0} failedQueries={0} />
    )
  ...
  it('shows "Found 87 jobs so far..." when searching with results', () => {
    renderWithIntl(
      <SearchStatusBar phase="searching" totalFound={87} pendingQueries={0} failedQueries={0} />
    )
  ...
  it('shows "Found 423 jobs matching your search" when complete', () => {
    renderWithIntl(
      <SearchStatusBar phase="complete" totalFound={423} pendingQueries={0} failedQueries={0} />
    )
    expect(
  ...
  it('shows "Found 342 jobs (1 search failed)" when complete with failures', () => {
    renderWithIntl(
      <SearchStatusBar phase="complete" totalFound={342} pendingQueries={0} failedQueries={1} />
    )
    expect(
  ...
  it('shows "No jobs found" when complete with 0 results', () => {
    renderWithIntl(
      <SearchStatusBar phase="complete" totalFound={0} pendingQueries={0} failedQueries={0} />
    )
    expect(
  ...
  it('does not show spinner when complete', () => {
    renderWithIntl(
      <SearchStatusBar phase="complete" totalFound={10} pendingQueries={0} failedQueries={0} />
    )
