...
interface PersonalLetterCardProps {
...
export function PersonalLetterCard({
  document,
  title,
  noDocumentText,
  viewDocumentLabel,
  ...
  return (
    <div
      ...
      data-guide-id="dashboard-personal-letter-card"
      ...
      <div className="mt-3.5 space-y-3.5">
        ...
        <div className="flex items-center gap-5 pt-0.5">
          ...
          <button
            ...
            data-guide-id="dashboard-letter-upload-new"
